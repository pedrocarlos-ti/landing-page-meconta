    ...
    <div className="services">
      ...
      <div className="services_box">
        ...
        <p className="services_box_subtitle">
          ...
          outros. Para isso, oferecemos um ombro amigo, sessões com o intuito de
          promover condições para que seu sofrimento possa ser expresso.
        </p>
      </div>
      ...
      <div className="services_box">
        ...
        <p className="services_box_subtitle">
          ...
          conseguimos te ajudar com isso! Oferecemos sessões de aconselhamentos
          no processo de escolha de profissão, para te auxiliar a fazer escolhas
          maduras e coerentes, ajustadas com seus interesses, aptidões e
          possibilidades.
        </p>
      </div>
